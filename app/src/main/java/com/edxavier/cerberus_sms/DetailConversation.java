...
public class DetailConversation extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            tracker.setScreenName("Detail Conversation");
        ...
        sms_list = new ArrayList<InboxSms>();
        ...
        try {
            ...
            while (cursor.moveToNext()){
                ...
                sms.setSender_name(nombre);
                sms.setMsg_body(body);
                sms.setFecha(new Date(date));
                sms.setMsg_type(type);
                sms_list.add(sms);
            }
        }catch (Exception e){
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(MSG_TYPE.equals("android.provider.Telephony.SMS_RECEIVED"))
            {
                ...
                if(smsMessage[0].getOriginatingAddress().equals(numero.replaceAll("\\s+",""))) {
                    ...
                    inboxSms.setMsg_body(msg);
                    inboxSms.setSender_name(nombre);
                    inboxSms.setFecha(date);
                    inboxSms.setMsg_type(Constans.MESSAGE_TYPE_INBOX);
                    adapter.addItem(inboxSms);
                    scaleInAnimationAdapter.notifyItemInserted(0);
